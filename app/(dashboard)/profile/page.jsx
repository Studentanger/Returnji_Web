  ...
  return (
    <div className="max-w-6xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        {/* Coins Card */}
        <div className="bg-[#3b5034] rounded-[2rem] p-8 text-white relative overflow-hidden shadow-xl shadow-blue-900/20">
          {/* Decorative shapes */}
          ...
          <div className="relative z-10 flex flex-col h-full justify-between gap-6">
            <div className="flex items-center justify-between">
              <span className="text-blue-100 font-medium text-sm">Returnji Coins Balance</span>
      ...
      <div className="mt-20 pt-8 border-t border-gray-100 flex flex-col items-center justify-center gap-4 pb-4">
        ...
        <p className="text-[10px] text-gray-400">© 2023 Returnji. All rights reserved.</p>
      </div>
